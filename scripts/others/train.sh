...
python -m torch.distributed.launch --nproc_per_node 8 --master_port=29501  main_align_sapiens_pretrain.py \
  ...
  --output_dir=work_dirs/hd1m_repa_align_expert_sapiens_100e_vit_tiny_posemb224_multiscale_train \
  --log_dir=work_dirs/hd1m_repa_align_expert_sapiens_100e_vit_tiny_posemb224_multiscale_train \
