...
#SBATCH --output=slurm_logs/kd_sapiens_patch-%j.out
#SBATCH --error=slurm_logs/kd_sapiens-patch-%j.err
...
output_dir="work_dirs/sapiens-l_to_vit_tiny_hw256_cp128_patch2"
...
cp "main_align_pretrain_patch.py" "$output_dir/"
echo "start training"

torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=29601 main_align_pretrain_patch.py \
