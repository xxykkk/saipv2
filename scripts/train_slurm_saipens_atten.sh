...
output_dir="work_dirs/sapiens-l_to_vit_tiny_hw256_cp128_atten"
...
cp "main_align_pretrain_atten.py" "$output_dir/"
echo "start training"

torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=29601 main_align_pretrain_atten.py \
