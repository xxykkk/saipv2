...
# task_sp_list:  # wrong list would somehow cause .cuda() stuck without error
# pretrained: True
...
# model=vit_large_patch16_ladder_attention_share_pos_embed(
    # task_sp_list=['cls_token', 'cls_token_pos_embed', 'rel_pos_h', 'rel_pos_w'],
    # img_size=224,
    # patch_size=16,
    # lms_checkpoint_train=fairscale,
    # windwow=False,
...
if __name__=='__main__':
    ...
    pth_path='/home/liuke/data/ProgramFiles/huggingface/custom/PATH/PATHl.pth'
