...
def parse_args():
    ...
    parser.add_argument("--model_path", type=str, 
                        default='pretrained_models/sapiens/sapiens_0.3b/sapiens_0.3b_coco_best_coco_AP_796.pth', 
...
def main():
    ...
    args.output_folder = os.path.join(args.output_folder, os.path.basename(args.model_path).replace('.pth', ''))
    ...
    # extract features
    for batch_inputs, batch_paths in tqdm(dataloader, disable=(torch.distributed.get_rank() != 0)):
        ...
        for i, image_path in enumerate(batch_paths):
            ...
            torch.save(features[i].clone(), output_path)
